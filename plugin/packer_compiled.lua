...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["friendly-snippets"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  neovim = {
    ...
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/neovim",
